...
try {
  ...
  if ($order === 'desc') {
    ...
    $sql_select = 'SELECT * FROM books FROM WHERE books_name LIKE :keyword ORDER BY updated_at DESC';;
  } else {
...
<body>
  ...
  <main>
    <article class="books">
      ...
      <div class="books-ui">
        <div>
          <a href="read.php?order=desc&keyword=<?= $keyword ?>"></a>
            <img src="images/desc.png" alt="降順に並び替え" class="sort-img">
          </a>
          <a href="read.php?order=asc&keyword=<?= $keyword ?>"></a>
